...
create table ComarcasGalicia(
    ...
    Nomre				varchar( 30 ),
    Provincia			int,
	PRIMARY KEY concat( Provincia, Comarca),
	constraint miclaveForanea  FOREIGN KEY( Provincia ) REFERENCES ProvinciasGalicia( Provincia )
			#ON DELETE	CASCADE
            #ON UPDATE	CASCADE
);

ALTER TABLE COMCARCASGALICIA
RENAME COLUMN NOMRE TO NOMBRE;
CHANGE COLUMN NOMRE (NOMBRE)  VARCHAR(50);
...
#*******************************************************************************************
	create table PoblacionGalicia(
		...
		FOREIGN KEY concat( Provincia, Comarca, Concello  ) REFERENCES ConcellosGalicia( Provincia, Comarca, Concello )
			#ON DELETE	CASCADE
            #ON UPDATE	CASCADE
);
...
select distinct  concat (provincia,comarca,concello) from concellosGalicia;
